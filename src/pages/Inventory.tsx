...
import { Plus, Package, Minus, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {filteredMeds.map(med => {
          ...
          return (
            <div key={med.id} className={`bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border ${isLowStock ? 'border-rose-200 dark:border-rose-900/50' : 'border-slate-100 dark:border-slate-700'} flex flex-col gap-3 transition-colors`}>
